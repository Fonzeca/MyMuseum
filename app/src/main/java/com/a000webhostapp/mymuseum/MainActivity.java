...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, AdminPanelFragment.OnFragmentInteractionListener, InfoMuseoFragment.OnFragmentInteractionListener, InicioFragment.OnFragmentInteractionListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_inicio){
            ...
            fragmentClass = InfoMuseoFragment.class;
        }
    ...
    public void startNuevoInventoActivity(View view) {
